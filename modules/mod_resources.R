...
If you find an entry incorrectly valued, feel free to revalue it. Any changes made will be saved to a Google Sheet and be made persistently available to the application."),
